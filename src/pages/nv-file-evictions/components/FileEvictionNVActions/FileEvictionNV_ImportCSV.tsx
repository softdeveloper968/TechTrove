...
import { convertDateStringToUTCISOString, formatCurrency, handlePostalCodeKeyDown } from "utils/helper";
...
type FileEvictionNVImportCsvProps = {
...
const FileEvictionNV_ImportCsv = (props: FileEvictionNVImportCsvProps) => {
    const { 
        getNVEvictions, 
        allCompanies,
        getAllCompanies
            ...
            try {
                ...
                if (userRole.includes(UserRole.C2CAdmin)||userRole.includes(UserRole.ChiefAdmin)) {
                    if (selectedCompany.id != '' && selectedCompany.value != '') {
                        ...
                        const response = await LateNoticesService.createTenantEviction(
                            formattedData
                        );
                        if (response.status === HttpStatusCode.OK) {
                            ...
                            toast.error("Failed to create NV eviction.");
                        }
                    } else {
...
export default FileEvictionNV_ImportCsv;
